...
(function() {
  var AttributeUI, ContentTools, CropMarksUI, PDFDialog, PDFTool, StyleUI, TimeDialog, TimeTool, exports, _EditorApp,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __slice = [].slice;
  ...
  PDFTool = (function(_super) {
    __extends(PDFTool, _super);

    function PDFTool() {
      return PDFTool.__super__.constructor.apply(this, arguments);
    }

    ContentTools.ToolShelf.stow(PDFTool, 'pdf');
    ...
    PDFTool.apply = function(element, selection, callback) {
      var app, dialog, from, modal, selectTag, to, toolDetail, _ref;
      toolDetail = {
        'tool': this,
        'element': element,
        'selection': selection
  ...
  PDFDialog = (function(_super) {
    __extends(PDFDialog, _super);

    function PDFDialog() {
      PDFDialog.__super__.constructor.call(this, 'Upload PDF');
      this._pdfURL = null;
      this._progress = 0;
      this._state = 'empty';
    ...
    PDFDialog.prototype.mount = function() {
      var domActions, domProgressBar, domTools;
      PDFDialog.__super__.mount.call(this);
      ContentEdit.addCSSClass(this._domElement, 'ct-pdf-dialog');
      ContentEdit.addCSSClass(this._domElement, 'ct-pdf-dialog--empty');
      ContentEdit.addCSSClass(this._domView, 'ct-pdf-dialog__view');
      domTools = this.constructor.createDiv(['ct-control-group', 'ct-control-group--left']);
      this._domControls.appendChild(domTools);
      domProgressBar = this.constructor.createDiv(['ct-progress-bar']);
      domTools.appendChild(domProgressBar);
      ...
      domActions.appendChild(this._domUpload);
      this._domInput = document.createElement('input');
      this._domInput.setAttribute('class', 'ct-pdf-dialog__file-upload');
      this._domInput.setAttribute('name', 'file');
      this._domInput.setAttribute('type', 'file');
      this._domInput.setAttribute('accept', 'application/pdf');
      this._domUpload.appendChild(this._domInput);
      this._addDOMEventListeners();
      return this.dispatchEvent(this.createEvent('pdfuploader.mount'));
    };

    PDFDialog.prototype.progress = function(progress) {
      if (progress === void 0) {
        return this._progress;
      }
      this._progress = progress;
    ...
    PDFDialog.prototype.save = function(pdfURL) {
      return this.dispatchEvent(this.createEvent('save', {
        'href': pdfURL,
        'target': '_blank'
      }));
    ...
    PDFDialog.prototype.state = function(state) {
      var prevState;
      if (state === void 0) {
        return this._state;
      }
      ...
      ContentEdit.addCSSClass(this._domElement, "ct-pdf-dialog--" + this._state);
      return ContentEdit.removeCSSClass(this._domElement, "ct-pdf-dialog--" + prevState);
    };

    PDFDialog.prototype.unmount = function() {
      PDFDialog.__super__.unmount.call(this);
      this._domInput = null;
      this._domProgress = null;
      this._domUpload = null;
    ...
    PDFDialog.prototype._addDOMEventListeners = function() {
      PDFDialog.__super__._addDOMEventListeners.call(this);
  ...
  ContentTools.DEFAULT_TOOLS[0].push('pdf');
